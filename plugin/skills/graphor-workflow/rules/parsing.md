...
**This step is only required if you did not set a `partition_method` during upload.** If you set `partition_method` at upload time, processing starts automatically — you do not need to call parse.
